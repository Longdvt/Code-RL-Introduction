...
# expectation for rental request in second location
RENTAL_REQUEST_SECOND_LOC = 4
# expectation for # of cars returned in fisrt location
RETURNS_FIRST_LOC = 3
...
class PolicyIteration:
    ...
    def solve(self):
        ...
        while True:
            ...
            print(f"PE => Elpased time {elapsed_time} seconds")
            start_time = time.time()
        ...
        print(f"Optinal policy is reached after {iterations} iterations in {total_elapsed_time} seconds")
    ...
    def policy_improvement(self, actions, values, policy):
        ...
        print(f"Policy change in {policy_change} states")
    ...
    def bellman(self, values, action, state):
        ...
        for req1 in range(0, self.TRUNCATE):
            for req2 in range(0, self.TRUNCATE):
                ...
                prob = poisson(req1, RENTAL_REQUEST_FIRST_LOC) * poisson(req2, RENTAL_REQUEST_SECOND_LOC)
